...
class User implements \JsonSerializable
{
    ...
    public function passwordMatches($clearPassword) {
        return password_verify($clearPassword, $this->getPassword());
    }

    public function passwordNeedsRehash() {
        return password_needs_rehash($this->getPassword(), PASSWORD_DEFAULT);
    }
...
// password functions for PHP 5.4. Remove after upgrading to php 5.5.
